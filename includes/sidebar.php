                ...
                <ul>
                   ...
                   if(isset($_SESSION['type'])){
                    if($_SESSION['type'] =="admin"){
                       echo ' <li><a href="admin.php"><i class="ti-user"></i> Admin</a></li>';
                       echo '; <li><a href="teacher.php"><i class="ti-user"></i> Teacher</a></li>';
                       echo ';<li><a href="student.php"><i class="ti-user"></i> Sudent</a></li>';
                       echo ';<li><a href="parent.php"><i class="ti-user"></i> Parent</a></li>';
                    }
